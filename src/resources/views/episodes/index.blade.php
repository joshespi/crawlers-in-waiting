...
@section('content')
    <img src="{{ asset('images/album.jpg') }}" alt="{{ config('podcast.title') }}"
        class="w-full max-w-[700px] aspect-square rounded-xl object-cover ring-1 ring-stone-700 mb-10 mx-auto block">
                    ...
                    <div class="flex items-start justify-between gap-4">
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-3 mb-1">
                                <span
                                    class="text-xs text-amber-700 font-bold tracking-widest">{{ $episode->episode_label }}</span>
